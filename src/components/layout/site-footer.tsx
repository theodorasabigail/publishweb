...
export function SiteFooter({ settings }: { settings: SiteSettings }) {
  ...
  return (
    <footer className="mt-24 border-t border-bark-200/70 bg-bark-950 text-bark-100">
      <div className="container-page grid gap-10 py-14 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 text-xs text-bark-400">PT Aroma Pulau Arunika</p>
          ...
          <div className="mt-5 flex items-center gap-3">
            {settings.instagram_url && (
              <a
                ...
                className="rounded-full border border-bark-700 p-2 hover:border-bark-400"
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-wider text-bark-400">Shop</p>
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-wider text-bark-400">Read</p>
          <ul className="mt-4 space-y-2.5 text-sm">
      ...
      <div className="border-t border-bark-800">
        <div className="container-page flex flex-col gap-2 py-6 text-xs text-bark-400 sm:flex-row sm:items-center sm:justify-between">
